...
UPDATE "supplier_payments" sp
SET
  "amount_usd" = CASE WHEN sp.currency = 'USD' THEN ROUND(sp.amount::numeric, 6) ELSE ROUND((sp.amount::numeric / NULLIF(sp.exchange_rate::numeric, 0)), 6) END,
  "amount_cdf" = CASE WHEN sp.currency = 'CDF' THEN ROUND(sp.amount::numeric, 6) ELSE ROUND((sp.amount::numeric * sp.exchange_rate::numeric), 6) END
...
ALTER TABLE "supplier_payments" ALTER COLUMN "amount_usd" TYPE numeric(20,6) USING ROUND("amount_usd"::numeric, 6);
ALTER TABLE "supplier_payments" ALTER COLUMN "amount_cdf" TYPE numeric(20,6) USING ROUND("amount_cdf"::numeric, 6);
--> statement-breakpoint
